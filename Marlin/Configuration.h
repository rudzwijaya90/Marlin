 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 80, 400, 108.18 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 22, 53, -0.95 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN_LEFT 0
#define PROBING_MARGIN_RIGHT 25
#define PROBING_MARGIN_BACK 20 // (- lebih belakang, + lebih maju)
...
//// Solve Graphical LCD Artifacts
#define ST7920_DELAY_1 DELAY_NS(0) // After CLK LOW
#define ST7920_DELAY_2 DELAY_NS(63) // After DAT
#define ST7920_DELAY_3 DELAY_NS(125) // After CLK HIGH
